...
tk=tkr.Tk()
tk.title("LAB TEST 2.1 - IRM2017008")
...
for i in range(int(agent_count/2)):
    init_x=(random.randint(robot_radius,2*100-robot_radius)-100)+100
    init_y=(random.randint(robot_radius,2*100-robot_radius)-100)+100
    flag=1
    while(flag==1):
        flag=0
...
for i in range(int(agent_count/2)):
    init_x=(random.randint(robot_radius,2*100-robot_radius)-100)+500
    init_y=(random.randint(robot_radius,2*100-robot_radius)-100)+500
    flag=1
    while(flag==1):
        flag=0
        for j in range(len(initial_points)):
...
def get_k_rep(dist):
    ret=1000000000+(dist/(255*3))*90000000000
    return ret
